...
\myparagraph{Introducción a Sass}

Sass es un lenguaje de hojas de estilo que se compila a CSS básico. Permite, entre otras cosas, utilizar funciones, variables y herencia de selectores. Se utilizó en el desarrollo del template
de persona por el hecho de
que al utilizar selectores anidados se simplifica la lectura y comprensión de algunas partes de la implementación. Además, la opción de poder definir variables y funciones facilita mucho el desarrollo.
