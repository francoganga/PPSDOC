...
En el sistema se separaron las ABM entre aquellas que representan una relacion de 1-n, es decir, un lado de la relación puede relacionarse con muchos del otro lado. Este es el caso de la relación entre
\textbf{Proyecto} y \textbf{Miembro de Proyecto}. En estos casos se decidió por agregar el admin de miembros como \textit{hija} del admin de proyectos.
